...
{{-- <script src="{{ elixir('js/app.js') }}"></script> --}}
    ...
    <script src="{{ URL::asset('jquery-ui.min.js') }}"></script>
    <!-- Styles -->
...
{{-- <link href="{{ elixir('css/app.css') }}" rel="stylesheet"> --}}
    ...
    <link href="{{ URL::asset('jquery-ui.min.css') }}" rel="stylesheet">
</head>
<body id="app-layout">
...
@else
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ route('user.index') }}"><i class="fa fa-btn fa-cog"></i>Profiili</a></li>
